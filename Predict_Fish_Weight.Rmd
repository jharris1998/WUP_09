...
for Perch the best 2 regression models is Height and Width. Overall the best regression model is Height-Width with an adjusted r-squared of 0.9649
```{r}
...
the best regression model is L1-L2-L3-H-W. The best 2 regression models are Length1- Length3. The statistics on this adjusted r-squared is 0.9794
```{r}
PIKE3 <- lm(Weight ~ . -Height-Width-Length2,data=Pike)
summary.lm(PIKE3)
```
```{r}
