...
for Perch the best 2 regression models is Height and Width. Overall the best regression model is Height and Width with an adjusted r-squared of 
```{r}
...
the best regression model is L1-L2-L3-H-W. The best 2 regression models are Length1- Length3.
